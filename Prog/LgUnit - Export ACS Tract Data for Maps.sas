...
data ACS_2012_16_map; 
	...
	** Sum vars **;
	...
	allhh4plus = sum(of familyhh4plus nonfamilyhh4plus);
	...
	** Pct vars ** ;
	...
	pctallhh4plus = allhh4plus / numhshlds_2012_16;
	...
	** Create unformatted geo var **;
	...
	label all3brplusrentunits = "All 3br+ rental units"
		  ...
		  pctallhh4plus = "Percent of households with 4+ people"
	...
	** Keep vars for map **;
	...
	keep &geo. &geo.2 numhsgunits_2012_16 numhsgunits3plusbd_2012_16 numowneroccupiedhu_2012_16 numownocchu3plusbd_2012_16 pct3brown numrenteroccupiedhu_2012_16 numrentocchu3plusbd_2012_16 pct3brrent 
			numrnt3br_under1000 numrnt3br_under1500 pctrnt3br_under1000 pctrnt3br_under1500  pctnonfamilyhh4plus pctfamilyhh4plus pctallhh4plus
	;
