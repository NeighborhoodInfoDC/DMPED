...
changeinblack <- map_file %>% 
  ...
  mutate(quintile_12_22=cut(changeinblack_12_22,5, label = FALSE),
         quintile_00_22=cut(changeinblack_00_22,5, label = FALSE)) %>% 
  select(GEOID, NBH_NAMES,quintile_12_22,changeinblack_12_22,total_hh_2022, pct_black_2000, pct_black_2012,pct_black_2022 ) %>% 
  filter(quintile_12_22==1|quintile_12_22==2) #51 tracts 
