/**************************************************************************
 Program:  Aggregate Projections.sas
 Library:  DMPED
...
%macro get_sums;
	...
	%do i = 1 %to 4;
		...
		proc export data = Cluster_&thisvar. outfile = "L:\Libraries\DMPED\Raw\Projections\v1\Cluster_&thisvar..csv" dbms = csv replace; run;
		...
		proc export data = Ward_&thisvar. outfile = "L:\Libraries\DMPED\Raw\Projections\v1\Ward_&thisvar..csv" dbms = csv replace; run;
		...
		proc export data = Cluster_OCTO_&thisvar. outfile = "L:\Libraries\DMPED\Raw\Projections\v1\Cluster_OCTO_&thisvar..csv" dbms = csv replace; run;
