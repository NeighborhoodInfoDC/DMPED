/**************************************************************************
 Program:  DCHousing_needs_units_targets_HUD60.sas
 Library:  DMPED
  ...
  if (&hhinc.) in ( 9999999, .n ) then hud_inc = .n;
      ...
      when ( 1 )
        do;
          ...
          else if 29900 < &hhinc. <= 49850*2*0.6 then hud_inc = 2;* 60% = 50%amount (49850) *2 * 0.60 for HH of 1;
          else if 49850*2*0.6 < &hhinc. <= 49850*2*0.8 then hud_inc = 3; *using mathematical 80% limit not HUDs; 
      ...
      when ( 2 )
        do;
          ...
          else if 34200 < &hhinc. <= 56950*2*0.6 then hud_inc = 2; * 60% = 50%amount (56950) *2 * 0.60 for HH of 2;
          else if 56950*2*0.6 < &hhinc. <= 56950*2*0.8 then hud_inc = 3;  *using mathematical 80% limit not HUDs; 
      ...
      when ( 3 )
        do;
          ...
          else if 38450 < &hhinc. <= 64050*2*0.6 then hud_inc = 2; * 60% = 50%amount (64050) *2 * 0.60 for HH of 3;
          else if 64050*2*0.6 < &hhinc. <= 64050*2*0.8 then hud_inc = 3;  *using mathematical 80% limit not HUDs; 
      ...
      when ( 4 )
        do;
          ...
          else if 42700 < &hhinc. <= 71150*2*0.6 then hud_inc = 2; * 60% =50%amount (71150) *2 * 0.60 for HH of 4;
          else if 71150*2*0.6 < &hhinc. <= 71150*2*0.8 then hud_inc = 3;  *using mathematical 80% limit not HUDs; 
      ...
      when ( 5 )
        do;
          ...
          else if 46150 < &hhinc. <= 76850*2*0.6 then hud_inc = 2; * 60% =50%amount (76850) *2 * 0.60 for HH of 5;
          else if 76850*2*0.6 < &hhinc. <= 76850*2*0.8 then hud_inc = 3;  *using mathematical 80% limit not HUDs; 
      ...
      when ( 6 )
        do;
          ...
          else if 49550 < &hhinc. <= 82550*2*0.6 then hud_inc = 2; * 60% =50%amount (82550) *2 * 0.60 for HH of 6;
          else if 82550*2*0.6 < &hhinc. <= 82550*2*0.8 then hud_inc = 3;  *using mathematical 80% limit not HUDs; 
      ...
      when ( 7 )
        do;
          ...
          else if 52950 < &hhinc. <= 88250*2*0.6 then hud_inc = 2; * 60% =50%amount (88250) *2 * 0.60 for HH of 7;
          else if 88250*2*0.6 < &hhinc. <= 88250*2*0.8 then hud_inc = 3;  *using mathematical 80% limit not HUDs; 
      ...
      otherwise
        do;
          ...
          else if 56400 < &hhinc. <= 93950*2*0.6 then hud_inc = 2;* 60% =50%amount (93950) *2 * 0.60 otherwise;
          else if 93950*2*0.6 < &hhinc. <= 93950*2*0.8 then hud_inc = 3;  *using mathematical 80% limit not HUDs; 
