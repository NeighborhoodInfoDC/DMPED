/**************************************************************************
 ...
 Author:   Alexa Kort modifying original program by L. Hendey
 Created:  05.22.24
 Version:  SAS 9.4
 Environment:  Local Windows session (desktop)
 
 Description: Assign jurisdiction based on 2022 PUMAS for ACS IPUMS data for the COGS region:
  1="DC"
  2="Charles County"
  3="Frederick County "
  4="Montgomery County"
...
%macro assign_jurisdiction;
  ...
  select ( upuma );
    when ("1100101", "1100102", "1100103", "1100104", "1100105", "1100106") 
      Jurisdiction =1;
    when ("2401600") 
      Jurisdiction =2;
